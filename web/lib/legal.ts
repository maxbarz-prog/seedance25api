...
export const REFUNDS = [
  ...
  ["Unspent credits: 90% back", `Credits you BOUGHT and have not spent can be refunded to the original payment method at 90% of their value; the remainder covers the card fees charged on the purchase and on the refund. Credits you have already spent are not refunded: the provider was paid to render those videos the moment they were made, and that money cannot be recovered. Credits included with a plan are not refundable in any amount — they were granted, not purchased, and no money sits behind them. Request a refund at ${SUPPORT_EMAIL}.`],
  ["Did not receive what you paid for", `If a video you were charged for never reached you — the generation failed and was not refunded automatically, or the file is corrupt or the wrong length — tell ${SUPPORT_EMAIL} which video and when. We keep a record of every generation, when it finished, and whether it was viewed or downloaded, so we can check quickly and put it right in full, in credits or in money as you prefer.`],
